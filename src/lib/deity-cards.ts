...
// as plain original graphics - each deity's accent color, name, and a
// well-known mantra/greeting). Not a photograph: this app has no real deity
// photography of its own and no reliable way to verify the license or
// accuracy of one found online, so a card in the app's own style is the
// honest alternative. Used as the default share image so WhatsApp/
// Instagram/Facebook always have something ready before someone attaches
// their own photo or video.
