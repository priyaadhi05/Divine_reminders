...
const EN = {
  ...
  'home.about': 'Bhakti Reminder keeps track of festivals, vrathams and monthly sacred days for the deities you follow, and reminds you on your phone a few days before each one - so you never miss a special day.',
  'notify.blockedTitle': 'Notifications are turned off',
  'notify.blockedBody': "To get reminders, allow notifications for Bhakti Reminder in your phone's Settings.",
...
const TA: Record<TranslationKey, string> = {
  ...
  'home.about': 'Bhakti Reminder நீங்கள் வழிபடும் தெய்வங்களின் திருவிழாக்கள், விரதங்கள் மற்றும் மாதாந்திர புனித நாட்களைக் கண்காணித்து, ஒவ்வொன்றுக்கும் சில நாட்களுக்கு முன்பே உங்கள் தொலைபேசியில் நினைவூட்டுகிறது - எந்த சிறப்பு நாளையும் தவறவிடாமல் இருக்க.',
  'notify.blockedTitle': 'அறிவிப்புகள் அணைக்கப்பட்டுள்ளன',
  'notify.blockedBody': 'நினைவூட்டல்களைப் பெற, உங்கள் தொலைபேசியின் அமைப்புகளில் Bhakti Reminder-க்கு அறிவிப்புகளை அனுமதிக்கவும்.',
...
const TE: Record<TranslationKey, string> = {
  ...
  'home.about': 'Bhakti Reminder మీరు ఆరాధించే దేవతల పండుగలు, వ్రతాలు మరియు నెలవారీ పవిత్ర దినాలను గుర్తుంచుకుని, ప్రతి దానికి కొన్ని రోజుల ముందే మీ ఫోన్‌లో గుర్తు చేస్తుంది - ఏ ప్రత్యేక రోజునూ మీరు కోల్పోకుండా.',
  'notify.blockedTitle': 'నోటిఫికేషన్లు ఆఫ్‌లో ఉన్నాయి',
  'notify.blockedBody': 'రిమైండర్లు పొందడానికి, మీ ఫోన్ సెట్టింగ్స్‌లో Bhakti Reminder కోసం నోటిఫికేషన్లను అనుమతించండి.',
...
const KN: Record<TranslationKey, string> = {
  ...
  'home.about': 'Bhakti Reminder ನೀವು ಆರಾಧಿಸುವ ದೇವತೆಗಳ ಹಬ್ಬಗಳು, ವ್ರತಗಳು ಮತ್ತು ಮಾಸಿಕ ಪವಿತ್ರ ದಿನಗಳನ್ನು ಗಮನಿಸಿ, ಪ್ರತಿಯೊಂದಕ್ಕೂ ಕೆಲವು ದಿನಗಳ ಮೊದಲೇ ನಿಮ್ಮ ಫೋನ್‌ನಲ್ಲಿ ನೆನಪಿಸುತ್ತದೆ - ಯಾವುದೇ ವಿಶೇಷ ದಿನವನ್ನು ನೀವು ತಪ್ಪಿಸಿಕೊಳ್ಳದಂತೆ.',
  'notify.blockedTitle': 'ಅಧಿಸೂಚನೆಗಳು ಆಫ್ ಆಗಿವೆ',
  'notify.blockedBody': 'ಜ್ಞಾಪನೆಗಳನ್ನು ಪಡೆಯಲು, ನಿಮ್ಮ ಫೋನ್‌ನ ಸೆಟ್ಟಿಂಗ್ಸ್‌ನಲ್ಲಿ Bhakti Reminder ಗೆ ಅಧಿಸೂಚನೆಗಳನ್ನು ಅನುಮತಿಸಿ.',
...
const HI: Record<TranslationKey, string> = {
  ...
  'home.about': 'Bhakti Reminder आपके चुने हुए देवी-देवताओं के त्योहारों, व्रतों और मासिक पवित्र दिनों का ध्यान रखता है, और हर एक से कुछ दिन पहले आपके फ़ोन पर याद दिलाता है - ताकि कोई भी विशेष दिन छूट न जाए।',
  'notify.blockedTitle': 'सूचनाएँ बंद हैं',
  'notify.blockedBody': 'रिमाइंडर पाने के लिए, अपने फ़ोन की सेटिंग्स में Bhakti Reminder के लिए सूचनाएँ चालू करें।',
