...
const EN = {
  ...
  'deity.readFullText': 'Read the full text →',
...
const TA: Record<TranslationKey, string> = {
  ...
  'deity.readFullText': 'முழு உரையைப் படிக்க →',
...
const TE: Record<TranslationKey, string> = {
  ...
  'deity.readFullText': 'పూర్తి పాఠం చదవండి →',
...
const KN: Record<TranslationKey, string> = {
  ...
  'deity.readFullText': 'ಪೂರ್ಣ ಪಠ್ಯ ಓದಿ →',
...
const HI: Record<TranslationKey, string> = {
  ...
  'deity.readFullText': 'पूरा पाठ पढ़ें →',
